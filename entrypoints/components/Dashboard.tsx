...
const mockCases: CaseItem[] = [
  { id: 'CASE-001', title: 'Website Bug Investigation', status: 'active', createdAt: '2024-06-10' },
  { id: 'CASE-002', title: 'Performance Issue Analysis', status: 'pending', createdAt: '2024-06-09' },
  { id: 'CASE-003', title: 'User Experience Review', status: 'active', createdAt: '2024-06-08' },
  { id: 'CASE-004', title: 'Security Audit Report', status: 'closed', createdAt: '2024-06-07' },
];
...
export default function Dashboard() {
  ...
  const handleScreenshot = async (type: 'full' | 'visible' | 'region' = 'visible') => {
    ...
    try {
      ...
      if (type === 'region') {
        ...
        result = await screenshotService.captureFullScreen({ type: 'full', format: 'png' });
  ...
  const handleRegionSelect = async (region: RegionSelection) => {
    ...
    try {
      const result = await screenshotService.captureRegion(region, { format: 'png' });
  ...
  const handleDownloadScreenshot = () => {
    ...
    screenshotService.downloadScreenshot(screenshotPreview.dataUrl, screenshotPreview.filename);
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">Screen Capture Tool</h1>
                <p className="text-sm text-gray-500">Welcome back, {state.user?.username}</p>
              </div>
            </div>
            <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow p-6">
              <h2 className="text-lg font-medium text-gray-900 mb-4">Select Case</h2>
              ...
              <div className="space-y-2">
                <h3 className="text-sm font-medium text-gray-700">Available Cases:</h3>
                {mockCases.map((case_) => (
                  <div
                    key={case_.id}
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-500 mt-1">Created: {case_.createdAt}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow p-6">
              <h2 className="text-lg font-medium text-gray-900 mb-4">Capture Tools</h2>
              
              {!selectedCase ? (
                <div className="text-center py-12">
                  <div className="text-6xl mb-4">🎯</div>
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Select a Case First</h3>
                  <p className="text-gray-500">Choose a case from the left panel to enable capture tools.</p>
                </div>
              ) : (
                <div className="space-y-6">
                  {/* Selected Case Info */}
                  <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
                    <h3 className="font-medium text-blue-900">Working on: {selectedCase}</h3>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    ...
                    <div className="border border-gray-200 rounded-lg p-6">
                      <div className="text-center mb-4">
                        ...
                        <h3 className="text-lg font-medium text-gray-900 mb-2">Screenshot Capture</h3>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        >
                          {isCapturing && captureMode === 'screenshot' ? 'Capturing...' : 'Visible Area'}
                        </button>
                    ...
                    {/* Video Recording */}
                    <div className="border border-gray-200 rounded-lg p-6 text-center opacity-75">
                      <div className="text-4xl mb-4">🎥</div>
                      <h3 className="text-lg font-medium text-gray-900 mb-2">Video Recording</h3>
                      <p className="text-sm text-gray-600 mb-4">
                  ...
                  {/* Capture Status */}
                  {(isCapturing || captureMode) && !screenshotPreview && (
